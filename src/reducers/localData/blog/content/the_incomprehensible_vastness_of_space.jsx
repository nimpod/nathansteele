...
const IMAGES = {
    map_of_spacecrafts_that_have_reached_interstellar_space: "https://s3.eu-west-2.amazonaws.com/nathansteele.com/blog/the_incomprehensible_vastness_of_space/diagrams/map_of_spacecrafts_that_have_reached_interstellar_space.png"
}
...
export const post = () => (
    <div>
        <div className='intro-text blog-subsection'>
            ...
            <p className='note'>A <a href='https://exoplanets.nasa.gov/faq/26/what-is-a-light-year/'>lightyear</a> is a measurement of distance, specifically the amount of distance 
            ...
            <table className='time-to-get-to-alphacenturi-table'>
                <thead>
