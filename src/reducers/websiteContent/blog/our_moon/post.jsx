    ...
    return (
        <div>
            ...
            <div className='blog-subsection' id='section4'>
                ...
                <p>Once upon a time, there were giant magma oceans on the Moon. They survived for several millions of years in the Moon’s early life.</p>
                <p>Maria – the darker sections of the Moon – these were once huge magma oceans.</p>
                <p>Procellarum Kreep – a terrain that is found only on the near side of the Moon – defined by high concentrations of potassium, thorium, uranium, and phosphorus.</p>
            </div>
            ...
            <div className='blog-subsection' id='section6'>
                ...
                <p>In 2020, NASA detected water ice in the Clavius Crater, which is in the South Pole region of the Moon.</p>
                <p>There was not much, 1g of water ice per 1000g of every other material, which makes this crater 100x drier than the Sahara desert… Nevertheless, it was something!</p>
                <p>However, Clavius Crater is not a permanently shadowed crater (aka. Cold trap). We believe a far greater amount of water ice would accumulate in cold traps.</p>
                <p>Researchers used the LRO to study these cold traps, and found many small ones (1cm diameter) and a few big ones, and estimated that all of the cold trap combined would cover an area roughly sized 40,000 km2 in size – about the same size as Switzerland.</p>
            </div>
            ...
            <div className='blog-subsection' id='section11'>
                ...
                <p>In 2019, China became the first country to land a rover on the far side of the Moon.</p>
                <p>The rover part of the mission (Yutu-2) began its life in the Von Karman crater in the South Pole-Aitken Basin – an impact crater 2,500km in diameter and 13km deep (one of the largest impact craters in the solar system).</p>
                <p>One lunar day equals 14 Earth days, so while the rover bathes in 14 days of darkness, it powers down and enter hibernation.</p>
                <p>Yutu-2 has achieved some impressive things:</p>
                
                <h4>Grew plants on the Moon</h4>
                <p>The lander was carrying a 2.6kg mini-biosphere called the Lunar Micro Ecosystem (LME).</p>
                <p>This cylindrical biosphere is only 18cm long and 16cm in diameter. </p>
                <p>The purpose of this experiment was to assess the effects of lunar surface conditions (low gravity, intense radiation, and intense light) on the growth and health of Earth-based organisms.</p>
                <p>Air pressure and a constant temperature of 25°C are maintained inside the LME, however it must contend with &lt; 17% of Earth gravity…</p>
                <p>The LME carried six lifeforms:</p>
                <ul>
                ...
                <p>The total runtime for the experiment was 9 days.</p>
                <p>The first ever biological experiment on the Moon fully demonstrates that a regenerative ecosystem can be built on the Moon.</p>
                <p>However, it has shown us how difficult it is to survive on the Moon, in particular surviving the lunar night.</p>
                <p>In addition, although the plants can grow in the natural sunlight and radiation conditions on the Moon, the safety of these plants has not been evaluated. Whether or not it would be safe to actually the eat potatoes and use the cotton grown from this mini-biosphere requires further research.</p>
            ...
            <div className='blog-subsection' id='section14'>
                ...
                <p>The Moon is moving away from the Earth 4cm every year.</p>
                <p>The energy propelling it away comes primarily from Earth’s oceans. Other weaker forces also have an effect (the Moon’s tilt, elliptical orbit, influence of the Sun).</p>
                <p>About 50 billion years from now, if the Moon and Earth could somehow avoid the eventual death of our Sun (~5 billion years from now), the Moon would be so far away and its orbit so large, that Earth would eventually tidally lock to the Moon... </p>
                <p>Only one side of the Earth would ever see the Moon, the other side moonless.</p>
                <p>Unfortunately, humanity will not bear witness to such distant events. So next time you look up at the Man in the Moon, remember the processes that keep it there, contemplate on other planets throughout the vast Universe where moons of different colours/shapes/sizes/orbits/terrain shine brightly on alien worlds, and reflect on our insignificant, fleeting, brief, fortunate existence at a time in the Universe where we are lucky enough to make observations of “nearby” stars, exo-solar-systems, galaxies, compared to the inevitable incomprehensibly large, dark, lonely fate of our Universe due to cosmic inflation and black hole dominance.</p>
            </div>
