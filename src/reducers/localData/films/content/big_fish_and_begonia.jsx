...
export const review = (screenshots) => (
    <div className='review-content'>
        ...
        <div className="review-meRambling">
            ...
            <p>The <b>animation style</b> of this film is incredibly attractive and majestic, the <b>atmosphere</b> enveloped me, 
                the <b>soundtrack</b> has since been engraved in my mind, and some aspects of the <b>narrative</b> have 
                really resonated with me in terms of embracing life and death.
            </p>
