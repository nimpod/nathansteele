...
export const review = () => (
    <div className='review-content'>
        ...
        <div className="review-main">
            ...
            <p>
                The sound design on this album is immaculate. There are so many layers to each song, the harp, the flute, the drums, and many other instruments you can hear throughout the album.
            </p>
            <p>
                His music is relatively well-known in the New Age genre, but this album crosses into many other genres (jazz; prog pop; ambient). For fans of ambient music, Vollenweider's music must be experienced. This album, and Vollenweider's music in general, deserve so much more attention. He is still releasing new music to this day. In my opinion, this album is his greatest creation.
            </p>
            <p>
