...
json_output_filename = 'reviews-moreData.json'
...
"""
    1) find zip extract
    2) find csv (the order of the films that is eventually displayed in the UI is defined here)
    3) iterate over each row (i.e. each film) in csv
        4) append data about each film to a JSON array
    5) store final result in JSON file called 'reviews-moreData.json'
"""
