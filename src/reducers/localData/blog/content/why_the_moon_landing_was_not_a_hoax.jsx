...
const IMAGES = {
    ...
    */
    // diagrams...
    moon_landing_sites:                 "https://s3.eu-west-2.amazonaws.com/nathansteele.com/blog/why_the_moon_landing_was_not_a_hoax/diagrams/Moon_landing_sites.svg.png",

    // photos...
    flag_shadow_on_surface_of_the_moon: "https://s3.eu-west-2.amazonaws.com/nathansteele.com/blog/why_the_moon_landing_was_not_a_hoax/photos/flag_shadow_on_surface_of_the_moon.webp",
    lunar_lasers:                       "https://s3.eu-west-2.amazonaws.com/nathansteele.com/blog/why_the_moon_landing_was_not_a_hoax/photos/lunar_lasers.jpg",
    moon_rock:                          "https://s3.eu-west-2.amazonaws.com/nathansteele.com/blog/why_the_moon_landing_was_not_a_hoax/photos/moon_rock.webp",
}
...
export const post = () => (
    <div>
        ...
        <div className='blog-subsection' id='several-pieces-of-evidence'>
            <h3 className='subgroup-title'>1.1) The Lunar Laser Ranging Experiment</h3>
                <p>Reflectors were placed on the moon at just the right angle so that a laser can be fired from earth to the moon, which then bounces off these reflectors and back to the earth at the exact point it left.</p>
            ...
            <h3 className='subgroup-title'>1.5) Worldwide research and publicity</h3>
            ...
            <h3 className='subgroup-title'>1.6) Conspiracy theorists are crazy</h3>
        ...
        <div className='blog-subsection' id='typical-questions'>
            <h3 className='subgroup-title'>2.1) Where are the stars?</h3>
            ...
            <h3 className='subgroup-title'>2.2) But the flag is waving?</h3>
            ...
            <h3 className='subgroup-title'>2.3) But they passed through the Van Allen Radiation Belt?</h3>
            ...
            <h3 className='subgroup-title'>2.4) Who filmed Armstrong's first steps then?</h3>
            ...
            <h3 className='subgroup-title'>2.5) But we haven't we been back for 40 years?!</h3>
            ...
            <h3 className='subgroup-title'>Summary</h3>
